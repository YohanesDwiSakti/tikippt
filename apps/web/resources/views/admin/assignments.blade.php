                ...
                <form class="form-grid">
                    <div class="field">
                        ...
                        <select class="select">
                            ...
                            @empty
                                <option>Belum ada driver tersedia</option>
                            @endforelse
                        </select>
                    </div>
                    <div class="field">
                    ...
                    <div class="full">
                        <button class="button button-primary" type="button">Assign</button>
                    </div>
                </form>
            </article>
                ...
                <div class="table-wrap">
                    <table class="data-table">
                        ...
                        @forelse($packages as $package)
                            <tr>
                                <td><input type="checkbox" aria-label="Pilih {{ $package['receipt'] }}"></td>
